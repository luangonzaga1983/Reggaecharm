...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{
      background: 'radial-gradient(ellipse at top left, #0d1f0d 0%, #0d0d0d 60%)'
    }}>
      {/* Decorative stripes */}
      ...
      <div className="w-full max-w-sm animate-slide-up">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-white/40 mt-2 text-sm">One Love, One Cut.</p>
        </div>

        <div className="rasta-stripe rounded-t-xl" />
        <div className="glass-card rounded-b-xl rounded-tr-xl p-8">
          <h2 className="text-lg font-semibold text-rasta-cream mb-6">Entrar na conta</h2>
          ...
          <p className="text-center text-sm text-white/40 mt-6">
            Não tem conta?{' '}
            <Link href="/registro" className="text-rasta-green-light hover:text-rasta-green font-medium transition-colors">
              Cadastrar
            </Link>
          </p>
        </div>
