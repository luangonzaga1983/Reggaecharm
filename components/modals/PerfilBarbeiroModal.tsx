      ...
      <div className="modal-box" style={{ maxHeight: '95vh', overflowY: 'auto', padding: 0, maxWidth: 520 }}>
        <div style={{ padding: '16px 16px 0' }}>
          ...
          {isProprietario ? (
            ...
            <p style={{ fontSize: 11, color: 'var(--text-faint)', textTransform: 'uppercase', letterSpacing: '0.06em', fontWeight: 600, margin: '4px 0 0' }}>Fotos ({fotos.length})</p>
          )}
        </div>
        ...
        <div style={{ padding: '12px 16px 16px' }}>
          ...
          {abaAtiva === 'cortes' && isProprietario && (
